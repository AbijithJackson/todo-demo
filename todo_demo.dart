...
import '../helper/helper_demo.dart';
...
class _TodoDemoState extends State<TodoDemo> {
  ...
  void _refreshJournals() async {
    final data = await HelperDemo.getItems();
    setState(() {
      _journals = data;
      _isLoading = false;
  ...
  void _showForm(int? id) async {
    if (id != null) {
      ...
      _noteController.text = existingJournal['note'];
    }
...
// Insert a new journal to the database
  ...
  void _deleteItem(int id) async {
    await HelperDemo.deleteItem(id);
